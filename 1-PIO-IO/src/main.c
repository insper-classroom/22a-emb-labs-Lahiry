...
#define BUT_1_PIO  PIOD                          // periferico que controla o LED 01
#define BUT_1_PIO_ID  ID_PIOD                    // ID do periférico PIOA (controla LED 01)
#define BUT_1_PIO_IDX  28                         // ID do LED 01 no PIO
#define BUT_1_PIO_IDX_MASK  (1u << BUT_1_PIO_IDX)  // Mascara para CONTROLARMOS o LED 01

#define BUT_2_PIO  PIOC                          // periferico que controla o LED 02
#define BUT_2_PIO_ID  ID_PIOC                    // ID do periférico PIOC (controla LED 02)
#define BUT_2_PIO_IDX  31                        // ID do LED 02 no PIO
#define BUT_2_PIO_IDX_MASK  (1u << BUT_2_PIO_IDX)   // Mascara para CONTROLARMOS o LED 02
		
#define BUT_3_PIO  PIOA                          // periferico que controla o LED 03
#define BUT_3_PIO_ID  ID_PIOA                   // ID do periférico PIOB (controla LED 03)
#define BUT_3_PIO_IDX  19                         // ID do LED 03 no PIO
#define BUT_3_PIO_IDX_MASK  (1u << BUT_3_PIO_IDX)   // Mascara para CONTROLARMOS o LED 03
